...
<head>
    ...
    <style>
        ...
        .status-badge { padding: 0.25rem 0.5rem; border-radius: 9999px; font-size: 0.75rem; font-weight: 700; background: #ede9fe; color: #5b21b6; }
...
<body>
    <div class="container">
        <div class="header">
            <h1>Technician Staff List</h1>
            <a href="technician" class="add-new">+ Add New</a>
        </div>
        <div class="card">
            <table>
                <thead>
